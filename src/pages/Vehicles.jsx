...
export default function Vehicles() {
  ...
  return (
    <section className="container-x min-w-0 py-6 sm:py-12 lg:py-16">

      {/* =====================================================
          HEADER + FILTER AREA
      ====================================================== */}

      <div className="min-w-0 overflow-hidden rounded-[1.5rem] bg-gradient-to-br from-orange-100 via-white to-amber-50 p-4 shadow-sm sm:rounded-[2rem] sm:p-7 md:p-9 lg:p-10">
        ...
        <div className="mt-5 grid min-w-0 grid-cols-2 gap-2.5 sm:mt-7 sm:gap-3 lg:grid-cols-[1.5fr_repeat(3,1fr)_auto]">
          ...
          <select
            className="input h-10 min-w-0 w-full text-[11px] sm:h-auto sm:text-sm"
            value={type}
            onChange={(e) =>
      ...
      {filtered.length > 0 ? (
        ...
        <div className="mt-6 grid min-w-0 grid-cols-2 gap-2 sm:mt-8 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3">
        ...
        <div className="mt-6 rounded-2xl border border-orange-100 bg-orange-50/70 px-4 py-14 text-center sm:mt-8 sm:rounded-3xl sm:px-8 sm:py-20">
          ...
          <p className="mx-auto mt-1.5 max-w-md text-[11px] leading-relaxed text-slate-500 sm:mt-2 sm:text-sm">
            Try another category or clear your
            filters.
          </p>
